...
def main():
    """ The main function """
    df = pd.read_csv("~/Documents/Tautomers/databases/ANI1_cleaned_amons.csv").dropna(subset=["Smiles_A"]).reset_index(drop=True)
    enc = MHFPEncoder()
    ...
    f.add_scatter(
        ...
        point_scale=2.5,
        categorical=[True, True, True, True, False, False, False, False, False],
        has_legend=True,
        legend_labels=[
            [(0, "No"), (1, "Yes")],
            [(0, "No"), (1, "Yes")],
